...
function addYarn(event) {
    ...
    const yarnWeight = parseInt(yarnWeightInput.value);
...
function updateYarnList() {
    ...
    yarns.forEach((yarn, index) => {
        ...
        const totalLenght = yarn.lenght * yarn.quantity;
        ...
        li.innerHTML = `
            ...
            <span>Weight(name): ${yarn.weightName}</span><br>
            <span>Lenght: ${yarn.lenght}</span><br>
            <span>Total lenght: ${totalLenght}</span><br>
